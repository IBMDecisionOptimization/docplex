...
# ---------------------------------------------------------------------------
"""
Using the branch callback for optimizing a MIP problem with Special
Ordered Sets Type 1, with all the variables binary.
...
def admipex3(filename):
    ...
    # Ensure linear mappings between original and presolved space.
    # This is required to make sure branching decisions can be translated
    # between the original and the presolved model.
    c.parameters.preprocessing.reformulations.set(
        c.parameters.preprocessing.reformulations.values.none)
