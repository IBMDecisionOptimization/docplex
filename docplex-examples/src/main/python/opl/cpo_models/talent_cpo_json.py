...
(Optimization Programming Language) model as string, with data given as json
file path. It also illustrates how to extract OPL variables from the model.
"""
...
mdl = CpoModel()
mdl.build_opl_model(mod,data = './data/data_talent.json')
