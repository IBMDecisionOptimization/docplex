...
class CpoCompiler(object):
    ...
    __slots__ = ('model',                     # Source model
                 ...
                 'first_defined_loc_fname',   # If defined, first occurrence of non-null fname field for location
                 )
    ...
    def __init__(self, model, **kwargs):
        ...
        self.first_defined_loc_fname = None
            ...
            if loc != lloc:
                if loc is None:
                    ...
                    if (lloc is None) or (file != lloc[0]):
                        # Handle first occurrence of a location
                        if file is None and lloc is None:
                            file = self.first_defined_loc_fname
                        if file is not None:
    ...
    def _scan_expressions(self, lexpr, expr_infos, all_exprs):
        ...
        for expr, loc in lexpr:
            ...
            if xinfo is not None:
                ...
                # Save first occurrence of fname location if relevant
                if self.first_defined_loc_fname is None and loc is not None and loc[0] is not None:
                    self.first_defined_loc_fname = loc[0]
