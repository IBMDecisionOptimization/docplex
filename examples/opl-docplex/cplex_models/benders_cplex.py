...
(Optimization Programming Language) mod content as string, with json file path.
The json data contains key-value pair, where the keys represent variable names
...
mdl = ModelReader.build_opl_model(mod,data = './data/data_benders.json')
