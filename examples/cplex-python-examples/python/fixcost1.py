...
# ---------------------------------------------------------------------------
"""
A production planning problem with fixed costs.
...
def fixcost1():
    ...
    c.linear_constraints.add(lin_expr=[[["operate" + str(i), "use" + str(i)],
                             ...
                             senses="L" * n_machines,
                             rhs=[0.0] * n_machines)
    # if sense is not specified, all linear constraints are taken to be
    # equalities
    c.linear_constraints.add(
        lin_expr=[[list(range(n_machines)), [1.0] * n_machines]],
        rhs=[demand])
