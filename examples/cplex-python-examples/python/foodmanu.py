...
demonstrates the use of indicator constraints and semi-continuous
variables.
...
def foodmanu():
    ...
    for m in range(NUMMONTHS):
        ...
        print("  . buy   ", end=' ')
        for p in range(NUMPRODUCTS):
            print("%15.6f" % x[varindex(m, p, BUY)], "\t", end=' ')
        print()
        print("  . use   ", end=' ')
        for p in range(NUMPRODUCTS):
            print("%15.6f" % x[varindex(m, p, USE)], "\t", end=' ')
        print()
        print("  . store ", end=' ')
        for p in range(NUMPRODUCTS):
            print("%15.6f" % x[varindex(m, p, STORE)], "\t", end=' ')
        print()
