...
window.addEventListener("resize",
  () => (document.querySelector("li.nav-item-0 a").innerText = (window.innerWidth <= 776) ? "Top" : "DOcplex.MP: Mathematical Programming Modeling for Python V2.31 documentation")
)
